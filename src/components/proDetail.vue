    ...
    <div class="swiperWrap" @dblclick="goBack">
			<div class="box">
				<div class="title">
					...
					<div class="titleItem" style="height: 6rem">光度范围</div>
					...
					<div class="titleItem" style="height: 6rem" v-if="customFile">定制片光度范围</div>
				...
				<div class="title" style="flex:1;height: 4rem;"v-for="(item, index) in swiperList">
					...
					<div  class="titleItem" style="height: 6rem;background: #efefef">
					...
					<div  class="titleItem" style="height: 6rem;background: #efefef"  v-if="customFile">
...
<script>
  ...
  export default {
     created() {
		 this.id = window.sessionStorage.getItem('detailId');
		 this.getSwiper();
